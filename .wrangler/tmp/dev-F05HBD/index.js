...
// .wrangler/tmp/bundle-j7oD4h/checked-fetch.js
...
var worker_default = {
  async fetch(request, env) {
    ...
    if (url.pathname.startsWith("/api/")) {
      ...
      init.headers.set("host", new URL(env.API_ORIGIN).host);
...
// .wrangler/tmp/bundle-j7oD4h/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-j7oD4h/middleware-loader.entry.ts
